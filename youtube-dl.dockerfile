...
RUN apt-get update -y && apt-get install -y --allow-unauthenticated build-essential net-tools libffi-dev libffi6 gcc libmp3lame-dev libvorbis-dev libtheora-dev libspeex-dev yasm pkg-config libx264-dev ffmpeg apache2 curl python3 python3-dev python3-minimal python3-pip
...
#RUN apt-get update -y && apt-get install -y --allow-unauthenticated libffi-dev libffi6 gcc 
