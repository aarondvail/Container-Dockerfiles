...
#RUN echo 'path-exclude /usr/share/man/*' >/etc/dpkg/dpkg.cfg.d/docker-minimal && apt-get update && apt-get -y install apt-utils wget python3 xz-utils imagemagick xdg-utils && apt-get -y install --no-install-recommends libnss3 sqlite3 python3-pyqt5 python3-xdg bash-completion libegl1 libopengl0 qt5-image-formats-plugins qtwayland5 sqlite3-doc qttranslations5-l10n libqt5svg5 qt5-gtk-platformtheme libqt5sql5-sqlite libqt5sql5-psql libwacom-bin && apt-get clean 
RUN echo 'path-exclude /usr/share/man/*' >/etc/dpkg/dpkg.cfg.d/docker-minimal && apt-get update && apt-get -y install apt-utils wget python3 xz-utils imagemagick xdg-utils && apt-get -y install --no-install-recommends libnss3 sqlite3 python3-pyqt5 python3-xdg bash-completion libegl1 libopengl0 qt5-image-formats-plugins qtwayland5 sqlite3-doc qttranslations5-l10n libqt5svg5 qt5-gtk-platformtheme libqt5sql5-sqlite libqt5sql5-psql libwacom-bin libxcb-cursor0 && apt-get clean 
#RUN apt-get update && apt-get -y install apt-utils wget python3 xz-utils imagemagick xdg-utils && apt-get -y install --no-install-recommends libnss3 sqlite3 python3-pyqt5 python3-xdg bash-completion libegl1 libopengl0 qt5-image-formats-plugins qtwayland5 sqlite3-doc qttranslations5-l10n libqt5svg5 qt5-gtk-platformtheme libqt5sql5-sqlite libqt5sql5-psql libwacom-bin && apt-get clean 
